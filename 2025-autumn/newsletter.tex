...
I would also like to take this opportunity to thank our outgoing directors Cengiz Gunay, Christoph Metzner, Maurizio de Pitta and Srikanth Ramaswamy for their service. If you are interested in getting involved more deeply with CNS, please consider nominating yourself for election as a board member in the future.
...
\textcolor{BlueViolet}{%
  \Large
    \begin{itemize}
      ...
      \item Updates from CNS*2025 Firenze
...
See pictures from CNS*2025 Firenze here: \url{https://www.cnsorg.org/cns-2025-photo-album}.
\end{tcolorbox}
\end{center}
\vspace{1ex}
\centerline{\rule{0.5\textwidth}{0.4pt}}
...
\begin{figure}[!t]
  ...
  \includegraphics[height=16ex]{images/bojak}%
  \includegraphics[height=16ex]{images/Garagnani}%
  \includegraphics[height=16ex]{images/Gunay}\\%
  \includegraphics[height=16ex]{images/Kameneva}%
  \includegraphics[height=16ex]{images/thomask}%
  ...
  \includegraphics[height=16ex]{images/Metzner}%
  \includegraphics[height=16ex]{images/Mirasso}%
  ...
  \includegraphics[height=16ex]{images/Pinotsis}%
  \includegraphics[height=16ex]{images/Pitta}%
  \includegraphics[height=16ex]{images/Ramaswamy}%
...
\textbf{Row 2}: Christopher French, Shailesh Appukuttan*, Ingo Bojak, Max Garagnani, Cengiz Gunay.\\
\textbf{Row 3}: Tatiana Kameneva, Thomas Kn{\"o}sche, Kerstin Lenk, Eirini Mavritsaki, Albert Mazzoni, Robert McDougal.\\
\textbf{Row 4:} Christoph Metzner*, Claudio Mirasso, Michelle Moerel, Rodrigo de Oliveira Pena, Athanasia Papoutsi.\\
\textbf{Row 5:} Dimitrios Pinotsis, Maurizio de Pitta, Srikanth Ramaswamy, Ankur Sinha*.\\
(*Student/post-doc members)
\end{figure}

The current \href{https://www.cnsorg.org/board-of-directors}{Board of Directors} consists of 26 elected and ex officio members.
...
\clearpage
\section*{CNS*2025 Firenze: in charts}%
\sectionauthor{%
  \hspace{-1ex}\begin{tabularx}{\textwidth}{lX}%
...
\clearpage
\section*{CNS*2025 Firenze: From the Program Chair}%
...
\clearpage
\section*{CNS*2025 Firenze: Feedback form Summary}%
...
\begin{center}
  \begin{minipage}{\textwidth}
    \begin{center}
      Copyright \textcopyright{} OCNS 2025.\\\vspace{2ex}
