...
\begin{titlepage}
  ...
  \vspace{1ex}
  \textbf{\textcolor{white}{Member Newsletter\quad{}|\quad{}February 2026\quad{}|\quad{}Volume 9 No 2}}
  \vspace{1ex}
  \end{tcolorbox}
  \topskip0pt
  \vspace{-1.35ex}
  \includegraphics[width=\linewidth,keepaspectratio]{./images/halifax-1}\\
  \vspace{-4.5ex}
  \begin{tcolorbox}[colback=titletextbg, colframe=black, width=\textwidth, boxrule=0.5mm, leftrule=0mm, rightrule=0mm,sharp corners=all]
  \vspace{1ex}
  \begin{center}
  \textbf{\Huge\textcolor{white}{35\textsuperscript{th} Annual Computational Neuroscience Meeting}}\\
  \vspace{1ex}
  \textbf{\huge\textcolor{white}{Halifax, Nova Scotia, Canada}\\}
  \vspace{1ex}
  \textbf{\huge\textcolor{white}{July 11\textsuperscript{th}--15\textsuperscript{th}, 2026}}
  \end{center}
  \vspace{1ex}
  \end{tcolorbox}
  \vspace{4ex}
  ...
  \vspace{1ex}
  \begin{center}
    \href{https://mastodon.social/@OCNS}{\vcenteredinclude{./images/mastodon}}~
