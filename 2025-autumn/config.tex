...
\newcommand{\sectionauthorline}[2]{\begingroup
{\color{Blue}\textbf{\large #1\\}}\centerline{\rule{#2}{0.4pt}}\endgroup}
...
\definecolor{lighterOrange}{RGB}{255, 175, 95}
\definecolor{titletextbg}{RGB}{21, 95, 130}
