...
\sectionauthor{%
  \hspace{-1ex}\begin{tabularx}{\textwidth}{lX}%
    Local Organizers: & Cesar Renno-Costa, Federal University of Rio Grande do Norte\\
    & Renan Moioli, Federal University of Rio Grande do Norte, Brazil \\
    & Antônio Roque, University of São Paulo, Brazil \\
  \end{tabularx}}
\begin{figure}[ht]
  \centering
...
\begin{center}
  Please contact the Sponsorship Chairs, Max Garagnani and Dimitrios Pinotsis,\\ at \href{mailto:sponsorship@cnsorg.org}{sponsorship@cnsorg.org}\\ for information on sponsoring OCNS\@.
\end{center}
