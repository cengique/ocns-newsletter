...
\sectionauthor{Local Organizers: Michele Migliore, Institute of Biophysics, Palmero, Italy\\
\phantom{Local Organizers: }Sergio Solinas, University of Sassari, Sassari, Italy}
\begin{figure}[ht]
  \centering
...
\begin{wrapfigure}[8]{l}{0.45\textwidth}
  \includegraphics[width=0.45\textwidth]{images/Metacel_logo_2_crop}
\end{wrapfigure}
...
\begin{center}
  Please contact the Sponsorship Chair at \href{mailto:sponsorship@cnsorg.org}{sponsorship@cnsorg.org}\\ for information on sponsoring OCNS\@.
\end{center}
...
\begin{center}
  \begin{minipage}{\textwidth}
    \begin{center}
      ...
      Please contact the newsletter chair at \href{mailto:newsletter@cnsorg.org}{newsletter@cnsorg.org} for any contributions, corrections, clarifications, comments, and remarks.
    \end{center}
  \end{minipage}
\end{center}
\vfill
