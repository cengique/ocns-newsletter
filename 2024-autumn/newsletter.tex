...
\sectionauthor{
  ...
  \end{tabularx}}%
\begin{wrapfigure}[15]{l}{0.2\textwidth}
  \includegraphics[width=0.2\textwidth]{images/Garagnani}
  \includegraphics[width=0.2\textwidth]{images/Pinotsis}
\end{wrapfigure}

OCNS is a US 501c(3) non-profit organization supporting the international computational neuroscience community.
Our annual meetings draw about 500 attendees from a variety of backgrounds: physics, mathematics, computer science, biology, medicine, engineering, and others.
We seek sponsorship from corporate and philanthropic organizations for support of the annual CNS meeting.
...
These attendees will have access to main meeting, banquet and workshops at no cost for Gold and Platinum level sponsorships.
...
As we are a US based 501c(3) not-for-profit organization, sponsorship is tax-deductible to the extent provided by the US tax laws.
Gifts and contributions can be deducted except for the amount of waived registration fee.

\vspace{3ex}
\begin{center}
\begin{tcolorbox}[colback=CornflowerBlue, colframe=black, width=0.7\textwidth, boxrule=0.1mm]
\begin{center}
